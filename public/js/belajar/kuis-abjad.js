// Data soal untuk abjad A-Z
const questions = [
    { id: 1, image: "A", correct: "A", options: ["A", "B", "C", "D"] },
    { id: 2, image: "B", correct: "B", options: ["B", "C", "D", "E"] },
    { id: 3, image: "C", correct: "C", options: ["C", "D", "E", "F"] },
    { id: 4, image: "D", correct: "D", options: ["D", "E", "F", "G"] },
    { id: 5, image: "E", correct: "E", options: ["E", "F", "G", "H"] },
    { id: 6, image: "F", correct: "F", options: ["F", "G", "H", "I"] },
    { id: 7, image: "G", correct: "G", options: ["G", "H", "I", "J"] },
    { id: 8, image: "H", correct: "H", options: ["H", "I", "J", "K"] },
    { id: 9, image: "I", correct: "I", options: ["I", "J", "K", "L"] },
    { id: 10, image: "J", correct: "J", options: ["J", "K", "L", "M"] }
];
...
function updateSoal() {
    ...
    imagePlaceholderDiv.innerHTML = '<span>Gambar gestur tangan untuk huruf akan ditampilkan di sini</span>';
    pertanyaanH3.textContent = "Huruf apakah itu?";
