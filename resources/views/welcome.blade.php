...
<body>
  ...
  <div style="display: flex; flex-direction: column; width: 100%; min-height: 100vh; overflow-x: hidden; position: relative;">
    ...
    <!-- PAGE 2 - ABOUT -->
    <div class="ABOUT-US-VISI-MISI" id="tentang" style="position: relative; width: 100%;">
    ...
    <!-- PAGE 3 - FITUR -->
    <div class="FITUR-HARGA-PAKET" id="fitur" style="position: relative; width: 100%;">
    ...
    <!-- PAGE 4 - HARGA -->
    <div class="PAKET-PAKET" id="harga" style="position: relative; width: 100%;">
      <div class="group">
    ...
    <div class="lastt" id="last" style="position: relative; width: 100%;">
      ...
      <div class="bergabunglah-bersama-kami-and-mulai-pahami-bahasa-isyarat-dengan-cara-yang-mudah-inklusif-dan-ramah-untuk-semua">
