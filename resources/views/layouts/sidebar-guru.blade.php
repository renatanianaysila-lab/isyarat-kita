...
<aside class="sidebar">
  <div class="brand">
    <img class="logo-img" src="{{ asset('img/img/HANYA LOGO - Salin.png') }}" alt="Logo">
  ...
  <nav class="menu">
    ...
    <a class="menu-item {{ $menu == 'monitoring' ? 'active' : '' }}" href="{{ url('/dashboard-guru?menu=monitoring') }}" data-menu="monitoring">
      <img class="menu-icon" src="{{ asset('img/img/user.png') }}" alt="">
    ...
    <a class="menu-item {{ $menu == 'feedback' ? 'active' : '' }}" href="{{ url('/dashboard-guru?menu=feedback') }}" data-menu="feedback">
      <img class="menu-icon" src="{{ asset('img/img/feedback.png') }}" alt="">
      <span>Feedback & Rating</span>
    </a>

    <a class="menu-item {{ $menu == 'transaksi' ? 'active' : '' }}" href="{{ url('/dashboard-guru?menu=transaksi') }}" data-menu="transaksi">
      <img class="menu-icon" src="{{ asset('img/img/transaction-history.png') }}" alt="">
      <span>Transaksi</span>
    </a>
    ...
    <img class="menu-icon" src="{{ asset('img/img/logout-04.png') }}" alt="">
    <span>Logout</span>
    </a>
  </nav>
</aside>