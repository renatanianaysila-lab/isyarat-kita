<div class="katalog-container">
    ...
    <div class="paket-row">
        ...
        <div class="paket-card paket-dasar">
            ...
            <!-- LANGSUNG KE MATERI SAYA -->
            <a href="{{ url('/dashboard-murid?menu=materi') }}" class="btn btn-outline">Mulai Belajar →</a>
        </div>

        <!-- Paket Premium (tetap ke pembayaran) -->
        <div class="paket-card">
            ...
            <div class="premium-footer">Akses semua materi premium</div>
        </div>
    </div>
</div>